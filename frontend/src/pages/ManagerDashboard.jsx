...
export default function ManagerDashboard() { // Manager dashboard with broader org insights.
  ...
  const handleAssignTask = async (event) => { // Assign strategic task.
          ...
          <div className="grid-2">
            <div className="content-card">
              <div className="section-header">
                ...
                <p className="helper">Keep teams aligned on priorities.</p>
              </div>
              <form className="form-grid" onSubmit={handleAssignTask}>
                <div>
                  <label htmlFor="manager-task-employee">Employee</label>
                  <select
                    id="manager-task-employee"
                    name="employeeId"
                ...
                <div>
                  <label htmlFor="manager-task-due">Due Time</label>
                  <input
                    id="manager-task-due"
                    name="dueAt"
                    type="datetime-local"
                ...
                <div style={{ gridColumn: '1 / -1' }}>
                  <label htmlFor="manager-task-details">Details</label>
                  <textarea
                    id="manager-task-details"
                    name="details"
                    rows="3"
                    placeholder="Share the expected outcome and context"
